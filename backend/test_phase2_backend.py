...
#  Test 11: GIS Querier robustness 

def test_gis_querier():
    ...
    # Create a small polygon in Patna, Bihar (around 25.59, 85.13)
    coords = [
        (85.137, 25.594),
        (85.138, 25.594),
        (85.138, 25.595),
    ...
    poly = Polygon(coords)
    roads, rivers = gis_querier.get_nearby_vector_features(poly)
